...
async function deployDiamond() {
  ...
  let sbtFacetSelectors = getRemovedSelectorsBySelector(
    getSelectors(sbtFacet),
    facetCuts[0].functionSelectors
  );
  // console.log(sbtFacetSelectors + '\n')
  sbtFacetSelectors = getRemovedSelectorsBySelector(
    sbtFacetSelectors,
    facetCuts[1].functionSelectors
  );
  // console.log(sbtFacetSelectors + '\n')
  sbtFacetSelectors = getRemovedSelectorsBySelector(
    sbtFacetSelectors,
    facetCuts[2].functionSelectors
  );
  // console.log(sbtFacetSelectors + '\n')
  facetCuts.push({
